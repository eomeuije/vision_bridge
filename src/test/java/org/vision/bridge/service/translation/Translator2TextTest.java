...
//제4항 위배        t("'계, 례, 몌, 폐, 혜'의 'ㅖ'는 'ㅔ'로 소리 나는 경우가 있더라도 'ㅖ'로 적는다.", ",8@/\"`\"/\"`e/\"`d/\"`j/,8w`,8=/,8cz`,8=n,8\"u`,u\"o`ccz`@}m$`o/is\"<iu`,8=/,8\"u`.?czi4");
...
//        Assertions.assertEquals(translate, brfParser.translateBRF2Braille(">1\"<,:7".replaceAll("`", " ")));
        ...
        t("5+7=12", "#e5#g33#ab");
        t("9-3=6", "#i9#c33#f");
//'×'와 '연'이 제15항과 충돌        t("4×8=32", "#d*#h33#cb");
        t("12÷3=4", "#ab//#c33#d");
        t("7>5", "#g55#e");
        t("6<9", "#f99#i");
...
//'×'와 '연'이 제15항과 충돌        t("원의 면적은 반지름 × 반지름 × 3.14이다.", "p3w`e*.?z`~3.o\"{5`*`~3.o\"{5`* #c4adoi4");
...
//연산기호인지 아닌지 구별할수없음        t("드디어 서울-호치민의 항로가 열렸다.", "i[ios`,s&-ju;oeqw`j7\"u$`|\":/i4");
    ...
    void t(String p, String a) {
        ...
        String braille = brfParser.translateBRF2Braille(a.replaceAll("`", " "));
        translate = t.translate(braille);
        Assertions.assertEquals(translate.trim(), p);
    }
